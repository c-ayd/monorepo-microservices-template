namespace NotificationService.Worker.Abstractions
{
    ...
    public interface IEmailService
    {
        ...
        /// <param name="cancellationToken">Token to cancel the email sending process</param>
        Task SendAsync(string[] to, string subject, string body, bool isBodyHtml, CancellationToken cancellationToken = default);
    }
}
